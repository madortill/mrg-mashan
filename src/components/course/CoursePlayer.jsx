...
const appProps = {
  ...
  return {
    ...
    text: " בכל שלב תוכלו ללחוץ על השרוך בחזרה לפופ-אפ .אני אלווה אתכם במהלך הלומדה ובדוחות. תנווטו בלומדה דרך האפליקציות שייפתחו בלפטופ, ותוכלו לנוע בין הנושאים גם דרך שורת החיפוש העליונה .",
  };
