...
const INITIAL_NOTES = [
  {
    id: "note-1",
    title: "בכל בוקר",
    text: `מרכז הגיוס בונה ומפיץ דו"חות שונים ע"מ לסייע לקציני המשאן המילואים שבשגרה. בחלק מהפיקודים יישלח בנוסף לדוחות הטבלה מתכללת עם כלל החריגויות לפי החטיבות.`,
    top: 6,
    left: 6,
    width: 40,
  },
  {
    id: "note-2",
    title: "על כל קצין משאן מילואים",
    text: ` להיכנס לכל דו”ח לסנן ליחידות שלו ולטפל בחריגויות השונות ולהחזיר התייחסויות למר”ג בסטטוס החריגות `,
    top: 6,
    left: 52,
    width: 40,
  },
  {
    id: "note-3",
    title: "-דו”חות יומיים",
    text: ` (שמ”פ , מוקפאים, חו”ל)- יופקו כל יום ממענרכת הינשוף על ידי ק' משאן מילואים ויישמרו בתיקיית רשת. יודפסו בשת חירום בלבד. יש לשמור את הדוח של אותו היום. `,
    top: 52,
    left: 6,
    width: 40,
  },
