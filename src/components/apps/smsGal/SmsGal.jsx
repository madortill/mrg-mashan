...
const DECLINE_FOLLOWUP_MESSAGE =
    'מרכז גיוס אחראי על חיוג בחירום בהתאם לפקודת אמץ ולשבצק שלנו. באמצעות מערכת הקריאה, מרכז הגיוס מוציא חיוג לחיילי המילואים עפ הדרישה ומביא לקריאה של מקסימום חיילים במינימום זמן.';
